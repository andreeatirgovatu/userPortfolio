...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _express = __webpack_require__(/*! express */ \"express\");\n\nvar _auth = __webpack_require__(/*! ../../auth/auth */ \"./server/auth/auth.js\");\n\nvar _auth2 = _interopRequireDefault(_auth);\n\nvar _portfolioController = __webpack_require__(/*! ./portfolioController */ \"./server/api/portfolio/portfolioController.js\");\n\nvar _portfolioController2 = _interopRequireDefault(_portfolioController);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar controller = new _portfolioController2.default();\nvar auth = new _auth2.default();\nvar checkUser = [auth.decodeToken(), auth.getFreshUser()];\nvar portfolioRouter = (0, _express.Router)();\n\nportfolioRouter.route('/:userId/list').get(checkUser, controller.portfolioNames);\n\nportfolioRouter.route('/:userId').get(checkUser, controller.portfolioImages).post(checkUser, controller.createPortfolio).delete(checkUser, controller.deletePortfolio);\n\nportfolioRouter.param('portfolioId', controller.params);\nportfolioRouter.route('/:portfolioId/:userId').get(checkUser, controller.imagesFromPortfolio).put(checkUser, controller.updatePortfolio);\n\nportfolioRouter.route('/:imageId/:portfolioId/:userId').delete(checkUser, controller.deleteImage);\n\nexports.default = portfolioRouter;\n\n//# sourceURL=webpack:///./server/api/portfolio/portfolioRoutes.js?");
...
/***/ "./server/middleware/ensureAuthorized.js":
/*!***********************************************!*\
  !*** ./server/middleware/ensureAuthorized.js ***!
  \***********************************************/
/*! no static exports found */
